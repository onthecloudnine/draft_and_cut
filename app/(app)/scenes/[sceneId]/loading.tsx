export default function SceneDetailLoading() {
  return (
    <div className="flex h-full min-h-0 animate-pulse flex-col bg-background text-fg">
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-line px-5 py-3 sm:px-7">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="h-8 w-24 rounded-md bg-surface" />
          <div className="h-8 w-24 rounded-md bg-danger-soft" />
        </div>
      </div>

      <div className="flex shrink-0 gap-2 border-b border-line px-5 py-2 sm:px-7">
        <div className="h-8 w-28 rounded bg-surface" />
        <div className="h-8 w-20 rounded bg-surface" />
      </div>

      <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
        <div className="flex min-h-0 flex-1 flex-col bg-black">
          <div className="h-9 shrink-0 border-b border-line bg-background/40" />
          <div className="flex min-h-0 flex-1 items-center justify-center p-5">
            <div className="aspect-video w-full max-w-3xl rounded-md bg-surface" />
          </div>
          <div className="flex shrink-0 items-center gap-3 border-t border-line bg-background px-5 py-2">
            <div className="h-9 w-9 rounded-md bg-surface" />
            <div className="h-9 w-9 rounded-md bg-surface" />
            <div className="h-10 w-10 rounded-full bg-danger-soft" />
            <div className="h-9 w-9 rounded-md bg-surface" />
            <div className="h-9 w-9 rounded-md bg-surface" />
        ...
        <aside className="flex w-full shrink-0 flex-col gap-3 border-line bg-surface p-5 lg:w-[380px] lg:border-l xl:w-[420px]">
      ...
      <div className="shrink-0 border-t border-line bg-background px-3 py-3">
        ...
        <div className="flex gap-2 overflow-hidden">
          {Array.from({ length: 8 }).map((_, idx) => (
            <div className="h-[7.5rem] w-40 shrink-0 rounded-md bg-surface" key={idx} />
          ))}
        </div>
      </div>
    </div>
